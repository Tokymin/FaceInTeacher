package www.geekteam.xin.faceinteacher.view;
...
public class XListView3 extends ListView implements OnScrollListener {
	...
	public XListView3(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
	}

	public XListView3(Context context, AttributeSet attrs, int defStyle) {
